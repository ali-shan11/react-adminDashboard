        ...
        data: [
          {
            ...
            y: parsedData?.Cal_Avg_Vio_450nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Cal_Avg_Blu_500nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Cal_Avg_Grn_550nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Cal_Avg_Yel_570nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Cal_Avg_Org_600nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Cal_Avg_Red_650nm[0],
          },
        ],
      },
    ];
  ...
  return (
    <>
      <h3 style={{ margin: 0, marginTop: "50px" }}>
        This is the Calculated Average Graph Data
      </h3>
      <ResponsiveLine
        data={finalData}
        theme={{
