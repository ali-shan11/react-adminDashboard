        ...
        data: [
          {
            ...
            y: parsedData?.Raw_StdDev_Vio_450nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Raw_StdDev_Blu_500nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Raw_StdDev_Grn_550nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Raw_StdDev_Yel_570nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Raw_StdDev_Org_600nm[0],
          },
        ],
      },
      {
        ...
        data: [
          {
            x: parsedData?.Time_Stamp[0],
            y: parsedData?.Raw_StdDev_Red_650nm[0],
          },
        ],
      },
    ];
  ...
  return (
    <>
      <h3 style={{ margin: 0, marginTop: "50px" }}>
        This is the Raw Standard Deviation Graph Data
      </h3>
      <ResponsiveLine
        data={finalData}
        theme={{
